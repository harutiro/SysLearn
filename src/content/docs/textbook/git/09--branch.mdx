...
![](./_images/vscode-page-121.png)

## コンフリクトとは

Mainブランチはみんなで開発をするとコンフリクト（コードの衝突）が起きることもあります。

![](./_images/vscode-page-122.png)
...
![](./_images/vscode-page-125.png)

2. 作成したいブランチ名を記述して、エンターを押しましょう
   - 今回は `newBranch` という名前にします

![](./_images/vscode-page-126.png)
