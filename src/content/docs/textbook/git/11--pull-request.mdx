...
![](./_images/vscode-page-151.png)

### 手順2: New Pull Requestを選択

「New pull request」ボタンをクリックします。

![](./_images/vscode-page-152.png)
