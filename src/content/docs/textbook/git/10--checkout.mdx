...
![](./_images/vscode-page-142.png)

2. 選択がそのブランチに代わり、チェックアウトが完了します

![](./_images/vscode-page-143.png)
